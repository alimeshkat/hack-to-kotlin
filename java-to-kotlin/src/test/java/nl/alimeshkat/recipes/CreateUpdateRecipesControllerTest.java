...
import static nl.alimeshkat.recipes.test.util.RecipeAssert.assertRecipeResponse;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.emptyRequest;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.emptyRequestIngredient;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.errorMessageIncorrectIngredientName;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.errorMessageIncorrectIngredientType;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.errorMessageIncorrectIngredients;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.errorMessageIncorrectRecipe;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.errorMessageIncorrectRecipeName;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.errorMessageIncorrectWeight;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.ingredientMissingName;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.ingredientMissingType;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.ingredientMissingWeight;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.nullIngredientsRequest;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.nullRecipeNameRequest;
import static nl.alimeshkat.recipes.test.util.RecipeTestData.peperoniPizzaRecipeRequest;
