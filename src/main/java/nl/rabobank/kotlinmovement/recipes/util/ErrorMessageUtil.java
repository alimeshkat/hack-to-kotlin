package nl.rabobank.kotlinmovement.recipes.util;
...
public class ErrorMessageUtil {
    ...
    public static String toErrorMessage(MethodArgumentNotValidException methodArgumentNotValidException, String messagePrefix, String messagePostfix) {
    ...
    public static String toErrorMessage(List<String> messages, String messagePrefix, String messagePostfix) {
        if (messages == null) {
            return DEFAULT_ERROR_MESSAGE;
        }
        ...
        if (hasOneElement(orderedMessage)) {
            return getSingleErrorMessage(messagePrefix, messagePostfix, orderedMessage.get(0));
        } else {
            return getMultiErrorMessage(messagePrefix, messagePostfix, orderedMessage);
        }
    }
